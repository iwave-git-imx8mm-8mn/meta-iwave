...
IWG_BSP_VERSION = "${@bb.utils.contains_any('MACHINE', 'imx8mm-iwg34m imx8mm-iwg34m-2gb', '\r Rootfs Version : iW-PRFYZ-SC-01-R1.0-REL1.0-YoctoZeus\n', bb.utils.contains_any('MACHINE', 'imx8mn-iwg37m imx8mn-iwg37m-2gb', '\r Rootfs Version : iW-PRGJZ-SC-01-R1.0-REL1.0-YoctoZeus\n', '', d), d)}"

IWG_HOST = "${@bb.utils.contains_any('MACHINE', 'imx8mm-iwg34m imx8mm-iwg34m-2gb', 'iWave-G34M', bb.utils.contains_any('MACHINE', 'imx8mn-iwg37m imx8mn-iwg37m-2gb', 'iWave-G37M', '', d), d)}"
